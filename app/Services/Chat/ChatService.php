...
class ChatService
{
    ...
    private const SYSTEM_PROMPT = <<<'PROMPT'
        ...
        Scope: you only answer questions about football statistics, fixtures, predictions, referees, head-to-head records, and the app's own model accuracy, using ONLY the provided tools. Your data covers the top 5 European leagues (Premier League, La Liga, Serie A, Bundesliga, Ligue 1) from season 2023-24 onwards and refreshes nightly. When asked about anything outside that scope — other leagues or competitions, seasons before 2023-24, live in-play scores, transfer gossip, or non-football topics — briefly say it is outside your data and mention what you do cover.
